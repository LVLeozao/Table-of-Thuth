...
private Camada camada1, camada2, camada3;
	...
	public TelaJogo(String camadaTile1, String camadaTile2, String camadaTile3,
			String arquivoCamada1, String arquivoCamada2, String arquivoCamada3, 
			String imgInimigo, String poderImagemInimigo){
		...
		System.out.println(this.camadaTile1);
		...
		try {
			...
			inimigo1 = new Inimigo(imgInimigo, 32, 32, 4, 3, 3, 2000, 160, 640,true, poderImagemInimigo,
					4, 128, 500);
			inimigo2 = new Inimigo(imgInimigo, 32, 32, 4, 3, 3, 2000, 536, 136,true, poderImagemInimigo,
					4, 128, 500);
			inimigo3 = new Inimigo(imgInimigo, 32, 32, 4, 3, 3, 2000, 708, 436,true, poderImagemInimigo,
					4, 128, 500);

			personagens.add(inimigo1);
			personagens.add(inimigo2);
			personagens.add(inimigo3);
			//personagens.add(protagonista);
